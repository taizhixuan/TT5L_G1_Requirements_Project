...
*   **Product purpose —** SCMS exists *to streamline every aspect of club
    management and operation* by eliminating redundant paperwork, shortening
...
*   **Document purpose —** This SRS provides one authoritative reference for
    ...
    *ISO/IEC/IEEE 29148:2018* [\[1\]](#ref-iso)
...
<a id="ref-iso"></a>
1.  ISO/IEC/IEEE International Standard - Systems and software engineering -- Life cycle processes -- Requirements engineering. (2018). *ISO/IEC/IEEE 29148:2018(E)*, 1–104. doi:10.1109/IEEESTD.2018.8559686
...
| FR‑02  | The system shall integrate with the campus venue reservation system to check availability and submit booking requests.  | UC002, UC012                         | 1. Book Venue<br>2. Check Venue Availability                       |
| FR‑03  | The system shall track member RSVPs and provide attendee counts in real time.                                           | UC003, UC011                         | 1. View Event Attendance Count<br>2. RSVP Events                   |
| FR‑04  | The system shall send email and in‑app/push alerts to relevant users when an event proposal, budget request, or venue booking is approved, rejected, or requires action. | UC014                             | Receive System Notifications                                       |
...
| FR‑07  | The system shall allow club officers to seamlessly submit budget allocation requests to the university’s finance system.| UC010,UC013                         | 1. Submit Budget Allocation Request<br>2. Receive Budget Allocation Request |
...
Manages club operations, including creating events, submitting budget requests, and maintaining member records.
...
| Short  Description 	| The club member and club officer can personalize their own personal profile by editing their information like name, email, address, etc., within the system. 	|
| Goals              	| Allow users to view and update their profile information like name, email, address, etc., in the system.                                                      	|
| Actors             	| 1. Club Member<br>2. Club Officer                                                                                                                                	|
| Pre-conditions     	| 1. The users (club member and club officer) must be logged into the system.<br>2. The users must have access rights to edit their own profile.                   	|
...
| Short Description | The club officer enters the purpose of the budget, the amount they would like to request with optional supporting documents, and submits the budget request. |
...
| Actors             	| Campus Space Reservation Database                                                                                                                              	|
...
-   **Input/Output formats:**
    -   Budget reports exported as `.pdf` or `.xlsx`.
    -   Member records imported/exported as `.csv` or `.xlsx`.

-   **Elicitation evidence:**
    -   Workshop notes, interview transcripts, and Kano questionnaire responses are documented in Task 4.

-   **Elicitation method summary:**
    -   Multi-source elicitation: observation, interviews, workshops, and Kano survey.

-   **Problem context:**
    -   Club officers and members face difficulty managing events, budgets, and bookings due to decentralized and manual processes.

-   **Packaging:**
    -   System deployment shall include Docker containers and installation scripts for university IT integration.
...
8.  **A8: Sufficiency of Localization Support**
    *   **Description:** It is assumed that providing localization for English and Malay (UR-02) will adequately meet the language needs of the entire SCMS user base at Multimedia University.
    *   **Impact if False:** If a significant portion of the user base requires support for additional languages, the usability requirements (3.3) and development effort would need to be reassessed.
...
| **CSRD** | *Campus Space Reservation Database* — central database that stores venue schedules and booking records. |
