...
| FR‑02 a | The system shall integrate with the campus venue reservation system to submit booking requests.                                                                                           | UC012          | Book Venue                                                                  |
| FR‑02 b | The system shall integrate with the campus venue reservation system to check availability.                                                                                                | UC012          | Check Venue Availability                                                    |
| FR‑03 a | The system shall provide attendee counts in real time.                                                                                                                                    | UC003, UC011   | View Event Attendance Count Events                                          |
| FR‑03 b | The system shall track member RSVPs in real time.                                                                                                                                         | UC003, UC011   | RSVP Events                                                                 |
| FR‑04 a | The system shall send email and in‑app/push alerts to relevant users when an event proposal, budget request, or venue booking is approved.                                                | UC014          | Receive System Notifications                                                |
| FR‑04 b | The system shall send email and in‑app/push alerts to relevant users when an event proposal, budget request, or venue booking is rejected.                                                | UC014          | Receive System Notifications                                                |
| FR‑04 c | The system shall send email and in‑app/push alerts to relevant users when an event proposal, budget request, or venue booking requires action.                                            | UC014          | Receive System Notifications                                                |
